          ...
          <div className="max-w-3xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-xl text-muted-foreground">
                Learn how to use mockr.io to generate intelligent mock data for
                your applications.
              </p>
            </div>
            ...
            <div className="prose prose-slate dark:prose-invert max-w-none">
              <h2>Introduction</h2>
              <p>
                mockr.io is an AI-powered mock data generator designed for
                developers, testers, and data scientists. It provides a simple
                yet powerful way to generate realistic, contextually relevant
                mock data for your applications.
              </p>
              ...
              <div className="bg-primary/5 border rounded-lg p-4 my-6 flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Unlike traditional mock data generators that produce random
                    data, mockr.io uses AI to understand the relationships
                    between data fields, ensuring that the generated data is not
                    just random, but contextually relevant and realistic.
                  </p>
                </div>
              </div>
              ...
              <ul>
                <li>
                  <strong>AI-Powered Generation:</strong> Generate realistic
                  data using advanced AI models that understand context and
                  relationships.
                </li>
                <li>
                  <strong>Smart Schema Detection:</strong> Upload your database
                  schema or API spec for perfectly matching mock data.
                </li>
                <li>
                  <strong>Content Generation:</strong> Create realistic
                  articles, product descriptions, user bios, and more.
                </li>
                <li>
                  <strong>Multiple Export Formats:</strong> Export your mock
                  data in JSON, CSV, SQL, and more formats.
                </li>
                <li>
                  <strong>API Integration:</strong> Integrate with your
                  applications via our simple and powerful API.
                </li>
              </ul>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
                <Link href="/docs/quickstart" className="block">
                  <div className="border rounded-lg p-6 h-full hover:border-primary hover:bg-primary/5 transition-colors">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Get up and running with mockr.io in minutes with our quick
                      start guide.
                    </p>
                ...
                <Link href="/docs/ai/overview" className="block">
                  <div className="border rounded-lg p-6 h-full hover:border-primary hover:bg-primary/5 transition-colors">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Learn how to leverage our AI capabilities to generate more
                      realistic mock data.
                    </p>
                    <span className="text-primary font-medium inline-flex items-center">
                      Explore AI features{" "}
